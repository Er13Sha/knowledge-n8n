    ...
    public function answer(string $question, array $sources, array $history = []): string
    {
        ...
        $messages = [[
            ...
            'content' => implode("\n", [
                ...
                'После каждого утверждения указывай номер подтверждающего источника в формате [1].',
                'Используй только номера источников, которые есть в переданных фрагментах.',
                'Если данных недостаточно, прямо сообщи об этом и не делай предположений.',
