...
return [
    ...
    */
    ...
    'rag' => [
        ...
        'confidence_high_score' => env('RAG_CONFIDENCE_HIGH_SCORE', 0.75),
        'interaction_retention_days' => env('RAG_INTERACTION_RETENTION_DAYS', 90),
        'request_timeout' => env('RAG_REQUEST_TIMEOUT', 600),
    ],

    'extraction' => [
        'max_text_chars' => env('EXTRACTION_MAX_TEXT_CHARS', 200000),
        'max_table_rows' => env('EXTRACTION_MAX_TABLE_ROWS', 2000),
    ],
