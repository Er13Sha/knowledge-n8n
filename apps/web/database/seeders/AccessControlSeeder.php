...
class AccessControlSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['key' => 'extraction.use', 'name' => 'Извлечение данных'],
        ];
        ...
        DB::table('permission_role')->insertOrIgnore([
            ...
            ['permission_id' => $permissionIds['extraction.use'], 'role_id' => $roleIds['employee']],
            ['permission_id' => $permissionIds['extraction.use'], 'role_id' => $roleIds['admin']],
        ]);
