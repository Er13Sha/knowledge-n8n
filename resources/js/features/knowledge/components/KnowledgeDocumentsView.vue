...
import KnowledgeDocumentsPanel from './KnowledgeDocumentsPanel.vue';
...
<template>
    <header class="page-heading">
        ...
        <v-btn color="primary" prepend-icon="mdi-plus" @click="emit('upload')">
            Добавить документ
        </v-btn>
    </header>
